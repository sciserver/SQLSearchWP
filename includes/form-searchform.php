				...
				<form id="sqls-searchform">
					<div class="showme">
						<div class="form-group">
							...
							<select name="showme" id="sqls-showme">
								<option name="anyobjects" value="photoobj" selected="selected">Any objects</option>
								<option name="star" value="stars" >Stars</option>
								<option name="galaxy" value="galaxies" >Galaxies</option>
					...
					<div class="withmags">
						<div class="form-group">
							...
							<input type="text" name="umin" id="sqls-umin" min="0" max="30"><span class="ugrizrange">< u <</span><input name="umax" id="sqls-umax" min="0" max="30"><br>
							<input type="text" name="gmin" id="sqls-gmin" min="0" max="30"><span class="ugrizrange">< g <</span><input type="text" name="gmax" id="sqls-gmax" min="0" max="30"><br>
							<input type="text" name="rmin" id="sqls-rmin" min="0" max="30"><span class="ugrizrange">< r <</span><input type="text" name="rmax" id="sqls-rmax" min="0" max="30"><br>
							<input type="text" name="imin" id="sqls-imin" min="0" max="30"><span class="ugrizrange">< i <</span><input type="text" name="imax" id="sqls-imax" min="0" max="30"><br>
							<input type="text" name="zmin" id="sqls-zmin" min="0" max="30"><span class="ugrizrange">< z <</span><input type="text" name="zmax" id="sqls-zmax" min="0" max="30"><br>
						</div>
					</div>
					<div class="andcolors">
						<div class="form-group">
							<label>And colors: </label><br>
							<input type="text" name="ugmin" id="sqls-ugmin" min="-20" max="20"><span class="ugrizrange">< u-g <</span><input type="text" name="ugmax" id="sqls-ugmax" min="-20" max="20"><br>
							<input type="text" name="grmin" id="sqls-grmin" min="-20" max="20"><span class="ugrizrange">< g-r <</span><input type="text" name="grmax" id="sqls-grmax" min="-20" max="20"><br>
							<input type="text" name="rimin" id="sqls-rimin" min="-20" max="20"><span class="ugrizrange">< r-i <</span><input type="text" name="rimax" id="sqls-rimax" min="-20" max="20"><br>
							<input type="text" name="izmin" id="sqls-izmin" min="-20" max="20"><span class="ugrizrange">< i-z <</span><input type="text" name="izmax" id="sqls-izmax" min="-20" max="20"><br>
							<input type="text" name="urmin" id="sqls-urmin" min="-20" max="20"><span class="ugrizrange">< u-r <</span><input type="text" name="urmax" id="sqls-urmax" min="-20" max="20"><br>
						</div>
					...
					<div class="pleasereturn">
						...
						<div class="returnimg">
							<div class="form-group">
								...
								<input type="checkbox" name="imgdataobjids" value="p.objid" id="imgdataobjids"> Object IDs<br>
								<input type="checkbox" name="imgdataradec" value="p.ra, p.dec" id="imgdataradec" checked> RA and Dec<br>
								<input type="checkbox" name="imgdatamags" value="p.u, p.g, p.r, p.i, p.z" id="imgdatamags" checked> Magnitudes<br>
							</div>
						</div>
						<div class="returnspectra" id="sqls-returnspectra" aria-expanded="false" class="collapse in">
							<div class="form-group">
